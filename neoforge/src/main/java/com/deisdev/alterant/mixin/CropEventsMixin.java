...
public abstract class CropEventsMixin {
    ...
    private boolean alterant$beforeGrowthEvent(Level receiver, BlockPos eventPos, BlockState eventState, boolean chance, Operation<Boolean> original,
    ...
    private void alterant$growthResult(Level receiver, BlockPos eventPos, BlockState eventState, Operation<Void> original,
                                      BlockState state, ServerLevel level, BlockPos source, RandomSource random) {
