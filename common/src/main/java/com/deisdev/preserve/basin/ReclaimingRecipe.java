...
import com.deisdev.preserve.item.ReclamationJarItem;
import com.deisdev.preserve.item.ResidueFamily;
import com.deisdev.preserve.recipe.PreserveRecipes;
...
public record ReclaimingRecipe(ResidueFamily family, int count, Optional<Ingredient> additive, int additiveCount,
    ...
    @Override public RecipeSerializer<ReclaimingRecipe> getSerializer() { return PreserveRecipes.RECLAIMING.get(); }
    @Override public RecipeType<ReclaimingRecipe> getType() { return PreserveRecipes.RECLAIMING_TYPE.get(); }
    ...
    @Override public RecipeBookCategory recipeBookCategory() { return PreserveRecipes.RECLAIMING_CATEGORY.get(); }
    @Override public List<RecipeDisplay> display() {
        ...
        return List.of(new ShapelessCraftingRecipeDisplay(ingredients, new SlotDisplay.ItemStackSlotDisplay(result), new SlotDisplay.ItemSlotDisplay(PreserveBlocks.BASIN_ITEM.get())));
    }
}
