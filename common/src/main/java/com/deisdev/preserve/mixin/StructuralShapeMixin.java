...
import com.deisdev.preserve.engine.StructuralShapes;
...
public abstract class StructuralShapeMixin {
    ...
    private BlockState preserve$shapeProposal(BlockState proposal, BlockState before, LevelReader level, ScheduledTickAccess ticks,
