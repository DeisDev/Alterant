...
public final class PreserveRecipes {
    public static final Supplier<net.minecraft.world.item.crafting.RecipeType<com.deisdev.preserve.basin.ReclaimingRecipe>> RECLAIMING_TYPE = Services.PLATFORM.registerRecipeType("reclaiming");
    ...
    public static final Supplier<RecipeSerializer<com.deisdev.preserve.basin.ReclaimingRecipe>> RECLAIMING = Services.PLATFORM.registerRecipeSerializer("reclaiming", () -> com.deisdev.preserve.basin.ReclaimingRecipe.SERIALIZER);
