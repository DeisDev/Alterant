package com.deisdev.alterant.platform.services;

public interface IPlatformHelper {
    default java.util.function.Supplier<com.deisdev.alterant.item.ScraperItem> registerScraper() {
        return registerItem("scraper", com.deisdev.alterant.item.ScraperItem::new);
    }
    default java.util.function.Supplier<com.deisdev.alterant.item.ReleaseSolventItem> registerSolvent() {
        return registerItem("release_solvent", com.deisdev.alterant.item.ReleaseSolventItem::new);
    }
    default java.util.function.Supplier<com.deisdev.alterant.item.ShapingStylusItem> registerStylus() {
        return registerItem("shaping_stylus", com.deisdev.alterant.item.ShapingStylusItem::new);
    }
    ...
    void sendGameplay(net.minecraft.server.level.ServerPlayer player, com.deisdev.alterant.network.GameplayPayload payload);
    void sendSerumStatus(net.minecraft.server.level.ServerPlayer player, com.deisdev.alterant.network.SerumStatusPayload payload);
    java.util.function.Supplier<net.minecraft.server.level.TicketType> registerCleanupTicket();
    void sendInspection(net.minecraft.server.level.ServerPlayer player, com.deisdev.alterant.network.InspectionPayload payload);
    ...
    com.deisdev.alterant.rules.RuleLoad loadedRules(net.minecraft.server.MinecraftServer server);

    void sendTreatments(net.minecraft.server.level.ServerPlayer player, com.deisdev.alterant.network.ChunkTreatmentsPayload payload);
