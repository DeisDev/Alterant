...
import com.deisdev.alterant.engine.RemovalReceipt;
...
public final class ResidueDelivery {
    ...
    public void publishDrops() {
        ...
        for (var drop : drops) {
            ...
            catch (RuntimeException error) { com.deisdev.alterant.Constants.LOG.error("Could not publish a committed residue drop", error); }
        }
    }
}
