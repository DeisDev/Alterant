...
public abstract class StageGrowthMixin {
    ...
    private void alterant$beforeGrowthFeedback(BlockState state, ServerLevel level, BlockPos pos, RandomSource random, org.spongepowered.asm.mixin.injection.callback.CallbackInfo info) {
