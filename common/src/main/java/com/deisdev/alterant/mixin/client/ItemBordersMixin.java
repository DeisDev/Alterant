...
import com.deisdev.alterant.client.ItemBorderColors;
...
public abstract class ItemBordersMixin {
    ...
    private TextColor alterant$automaticBorder(TextColor original, ItemStack stack, HolderLookup.Provider provider) {
