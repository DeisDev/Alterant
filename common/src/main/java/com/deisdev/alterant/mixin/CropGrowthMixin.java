...
public abstract class CropGrowthMixin {
    ...
    private boolean alterant$naturalAge(ServerLevel receiver, BlockPos target, BlockState next, int flags, Operation<Boolean> original,
        ...
        var limited = com.deisdev.alterant.engine.GrowthControl.nextStage(level, source, target, next);
    ...
    private boolean alterant$bonemealAge(net.minecraft.world.level.Level level, BlockPos target, BlockState next, int flags, Operation<Boolean> original,
