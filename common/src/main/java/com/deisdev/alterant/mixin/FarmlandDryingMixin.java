...
public abstract class FarmlandDryingMixin {
    ...
    private boolean alterant$moistureLoss(ServerLevel level, BlockPos pos, BlockState next, int flags, Operation<Boolean> original) {
    ...
    private void alterant$dryDirt(Entity entity, BlockState state, Level level, BlockPos pos, Operation<Void> original) {
