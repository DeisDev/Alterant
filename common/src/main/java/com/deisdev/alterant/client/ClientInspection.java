...
import com.deisdev.alterant.network.InspectionPayload;
import com.deisdev.alterant.network.InspectionRequest;
...
public final class ClientInspection {
    ...
    private static int selection(Minecraft client) {
        return (client.player.getMainHandItem().getItem() instanceof PreservingBrushItem || client.player.getMainHandItem().getItem() instanceof com.deisdev.alterant.item.QuantumApplicatorItem)
