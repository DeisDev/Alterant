...
import com.deisdev.alterant.transfer.FabricTransfers;
...
public abstract class BlockApiCacheMixin {
    ...
    private Object alterant$guard(Object result, net.minecraft.world.level.block.state.BlockState state, Object context) {
